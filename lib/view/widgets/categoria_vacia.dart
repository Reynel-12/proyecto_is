...
class CategoriaVacia extends StatefulWidget {
  const CategoriaVacia({super.key});

  @override
  State<CategoriaVacia> createState() => _CategoriaVaciaState();
}

class _CategoriaVaciaState extends State<CategoriaVacia>
