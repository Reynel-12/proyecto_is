...
class ProveedorVacio extends StatefulWidget {
  const ProveedorVacio({super.key});

  @override
  State<ProveedorVacio> createState() => _ProveedorVacioState();
}

class _ProveedorVacioState extends State<ProveedorVacio>
              ...
              children: [
                ...
                Transform.translate(
                  ...
                  child: Opacity(
                    opacity: _fadeInAnimation.value,
                    child: Text(
                      'No hay proveedores por mostrar',
                      style: TextStyle(
